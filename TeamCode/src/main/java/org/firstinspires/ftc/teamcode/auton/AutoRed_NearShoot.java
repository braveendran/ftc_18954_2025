...
@Autonomous(name = "RedFar_ButNearShoot", group = "Autonomous")
@Disabled
public class AutoRed_NearShoot extends LinearOpMode {
...
//
//        objCommonFunc.strafe_right(params.DRIVE_SPEED_SLOW, 20, 5.0*2);
