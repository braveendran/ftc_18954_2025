...
public class AutonBlueClose extends LinearOpMode {
    ...
    // ---------------- LAUNCHER SETTINGS ----------------
    private final double LAUNCHER_MAX_VELOCITY = 4000;
    ...
    // ---------------- STOPPER SETTINGS ----------------
    private final double STOPPER_CLOSED = 0.48;
    private final double STOPPER_OPEN = 0.85;
    ...
    public void runOpMode() {
        ...
        StartShooter((int)(LAUNCHER_MAX_VELOCITY/12));

        // Step 1: Move forward away from the wall to get clearance for shooting.
        encoderDrive(DRIVE_SPEED/2, -30, -30 , 5.0*2); // Move forward 30 inches
        ...
        shootPowerCore((int)(LAUNCHER_MAX_VELOCITY/12),true);

        strafe(DRIVE_SPEED/2,48, 10);



        TurnOnIntake();

        encoderDrive(DRIVE_SPEED/2, 42, 42, 10*2);

        TurnOffIntake();

        encoderDrive(DRIVE_SPEED/2, -
                42, -42, 5.0*2);
...
//        }
    ...
    public void StartShooter(int LauncherVelocity) {
     ...
     */
    public void shootPowerCore(int LauncherVelocity,boolean started) {
